...
<script>
	$(document).ready(function() {
		...
		$("#nowPlayingBarContainer").on("mousedown touchstart mousmove touchmove", function (e) {
			e.preventDefault();
		});
...
function prevSong () {
	if(audioElement.audio.currentTime >= 3 || currentIndex ==0 ) {
		...
		setTrack(currentPlaylist[curentIndex], currentPlaylist, true);
	}
}
